...
export const DEV_AURORA_MAX_ACU = 8;
export const DEV_AURORA_AUTO_PAUSE_MINUTES = 10;
export const DEV_CLICKHOUSE_INSTANCE_TYPE = 't4g.large';
export const DEV_CLICKHOUSE_VOLUME_GIB = 100;
export const DEV_CLICKHOUSE_KAFKA_POLL_TIMEOUT_MS = 1000;
...
export const BRAND_CONTEXT_BASE_PREFIX = 'brand-context/';
export const DEV_BRAND_CONTEXT_UPLOADER_ROLE_NAME = 'loop-ad-dev-brand-context-uploader';
